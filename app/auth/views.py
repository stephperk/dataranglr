...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user is not None and user.verify_password(form.password.data):
            ...
            return redirect(request.args.get('next') or url_for('auth.show_user_home', username=current_user.username))
...
#before_app_request is site-wide and intercepts requests when three conditions are met
